...
package org.chipsalliance.dwbb.wrapper.DW_fifoctl_2c_df

import chisel3.experimental.IntParam
import org.chipsalliance.dwbb.interface.DW_fifoctl_2c_df._
import org.chipsalliance.dwbb.wrapper.WrapperModule

import scala.collection.immutable.SeqMap

class DW_fifoctl_2c_df(parameter: Parameter)
    extends WrapperModule[Interface, Parameter](
      ...
      p =>
        SeqMap(
          ...
          "ram_re_ext" -> IntParam(if (p.ramReExt) 1 else 0),
